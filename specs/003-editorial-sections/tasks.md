...
- [ ] T001 Membuat struktur direktori komponen di `src/components/layout/` dan `src/components/sections/`
- [ ] T002 Memvalidasi ketersediaan token warna Surakarta dan font Google di `src/app/globals.css` dan `tailwind.config.ts`
...
- [ ] T003 [P] Mendefinisikan antarmuka dan konstanta data editorial statis di `src/lib/config/wedding-content.ts`
- [ ] T004 [P] Menulis unit test untuk utilitas kalender di `src/lib/utils/calendar.test.ts`
- [ ] T005 Mengimplementasikan generator URL Google Calendar dan berkas RFC 5545 `.ics` di `src/lib/utils/calendar.ts`
- [ ] T006 [P] Menulis unit test untuk custom hook waktu mundur di `src/hooks/useCountdown.test.ts`
- [ ] T007 Mengimplementasikan custom hook reaktif `useCountdown` dengan pelindung hidrasi SSR di `src/hooks/useCountdown.ts`
...
- [ ] T008 [P] [US1] Menulis unit test untuk komponen HeroSection di `src/components/sections/HeroSection.test.tsx`

### Implementation for User Story 1
- [ ] T009 [US1] Mengimplementasikan komponen sampul majalah editorial `HeroSection` di `src/components/sections/HeroSection.tsx`
...
- [ ] T010 [P] [US2] Menulis unit test untuk komponen IslamicQuotes di `src/components/sections/IslamicQuotes.test.tsx`

### Implementation for User Story 2
- [ ] T011 [US2] Mengimplementasikan komponen `IslamicQuotes` dengan font Arab Amiri dan staggered reveal di `src/components/sections/IslamicQuotes.tsx`
...
- [ ] T012 [P] [US3] Menulis unit test untuk komponen CoupleProfile di `src/components/sections/CoupleProfile.test.tsx`

### Implementation for User Story 3
- [ ] T013 [US3] Mengimplementasikan komponen `CoupleProfile` dengan bingkai kubah ogee di `src/components/sections/CoupleProfile.tsx`
...
- [ ] T014 [P] [US4] Menulis unit test untuk komponen CountdownSection di `src/components/sections/CountdownSection.test.tsx`

### Implementation for User Story 4
- [ ] T015 [US4] Mengimplementasikan komponen `CountdownSection` berbingkai Gunungan Prada di `src/components/sections/CountdownSection.tsx`
...
- [ ] T016 [P] [US5] Menulis unit test untuk komponen EventDetails di `src/components/sections/EventDetails.test.tsx`

### Implementation for User Story 5
- [ ] T017 [US5] Mengimplementasikan komponen `EventDetails` dengan integrasi kalender dan navigasi peta di `src/components/sections/EventDetails.tsx`
...
- [ ] T018 [P] [US6] Menulis unit test untuk SmoothScrollProvider di `src/components/layout/SmoothScrollProvider.test.tsx`

### Implementation for User Story 6
- [ ] T019 [US6] Mengimplementasikan wrapper client `SmoothScrollProvider` berbasis Lenis di `src/components/layout/SmoothScrollProvider.tsx`
- [ ] T020 [US6] Mengintegrasikan `SmoothScrollProvider` dan seluruh seksi editorial ke dalam halaman utama di `src/app/page.tsx`
...
- [ ] T021 [P] Memverifikasi kepatuhan aksesibilitas (kontras WCAG AA, atribut RTL pada teks Arab, dan target sentuh minimal 44×44px)
- [ ] T022 [P] Memverifikasi query media `prefers-reduced-motion` pada HeroSection, IslamicQuotes, dan CountdownSection
- [ ] T023 Menjalankan pengujian otomatis penuh menggunakan `pnpm test` (wajib 100% lulus)
- [ ] T024 Menjalankan verifikasi tipe statis menggunakan `pnpm typecheck` (wajib 0 error)
- [ ] T025 Menjalankan pemeriksaan gaya kode dan kebersihan menggunakan `pnpm lint` (wajib 0 warning/error)
- [ ] T026 Melakukan verifikasi manual browser mengikuti skenario di `specs/003-editorial-sections/quickstart.md`
